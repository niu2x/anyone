...
TOLUA_API int tolua_isusertype(lua_State* L,
                               ...
                               tolua_Error* err);
TOLUA_API int
tolua_isvaluearray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
TOLUA_API int
tolua_isbooleanarray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
TOLUA_API int
tolua_isnumberarray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
TOLUA_API int
tolua_isstringarray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
TOLUA_API int
tolua_istablearray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
TOLUA_API int
tolua_isuserdataarray(lua_State* L, int lo, int dim, int def, tolua_Error* err);
...
TOLUA_API void tolua_pushusertype_and_addtoroot(lua_State* L,
                                                void* value,
                                                const char* type);
...
TOLUA_API void
tolua_pushfieldnumber(lua_State* L, int lo, int index, lua_Number v);
TOLUA_API void
tolua_pushfieldstring(lua_State* L, int lo, int index, const char* v);
TOLUA_API void
tolua_pushfielduserdata(lua_State* L, int lo, int index, void* v);
...
TOLUA_API lua_Number tolua_tofieldnumber(lua_State* L,
                                         int lo,
                                         int index,
                                         lua_Number def);
TOLUA_API const char*
tolua_tofieldstring(lua_State* L, int lo, int index, const char* def);
TOLUA_API void*
tolua_tofielduserdata(lua_State* L, int lo, int index, void* def);
TOLUA_API void*
tolua_tofieldusertype(lua_State* L, int lo, int index, void* def);
...
TOLUA_API void
tolua_dobuffer(lua_State* L, char* B, unsigned int size, const char* name);

TOLUA_API int class_gc_event(lua_State* L);

#ifdef __cplusplus
static inline const char* tolua_tocppstring(lua_State* L,
                                            int narg,
                                            const char* def)
{
...
tolua_tofieldcppstring(lua_State* L, int lo, int index, const char* def)
{
...
TOLUA_API int
tolua_fast_isa(lua_State* L, int mt_indexa, int mt_indexb, int super_index);
